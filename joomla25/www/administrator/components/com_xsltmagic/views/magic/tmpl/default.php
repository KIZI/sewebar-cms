<form action="index.php" method="post" name="adminForm">
		...
		<tr>
			...
			<th nowrap="nowrap" class="title">
				<?php echo JHTML::_('grid.sort',  'Source', 'source', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
						...
						<th nowrap="nowrap" class="title">
				<?php echo JHTML::_('grid.sort',  'Rule', 'rule', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th nowrap="nowrap" class="title">
				<?php echo JHTML::_('grid.sort',  'Last modified', 'modified', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
		</tr>
	</thead>
	<tfoot>
	...
	<?php for ($i=0, $n=count( $this->rows ); $i < $n; $i++) : $row = &$this->rows[$i]; ?>
		<tr class="row<?php echo $i % 2; ?>">
			...
			<td align="center">
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit' );?>::<?php echo $row->name; ?>">
					<a href="<?php echo $row->link; ?>"><?php echo $row->source; ?></a>
				</span>
			</td>
			<td align="center">
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit' );?>::<?php echo $row->name; ?>">
					<a href="<?php echo $row->link; ?>"><?php echo $row->rule; ?></a>
				</span>
			</td>
			<td align="center">
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit' );?>::<?php echo $row->name; ?>">
					<a href="<?php echo $row->link; ?>"><?php echo $row->modified; ?></a>
				</span>
			</td>
		</tr>
	<?php endfor; ?>
