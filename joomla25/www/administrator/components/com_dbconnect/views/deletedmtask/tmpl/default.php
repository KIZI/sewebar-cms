...
defined('_JEXEC') or die('Restricted access');
  ...
  $layoutUrl=JRequest::getVar('layout','');
  if ($layoutUrl!=''){$layoutUrl='&layout='.$layoutUrl;}
  echo '<form method="post" target="_parent" action="'.JRoute::_('index.php?option=com_dbconnect&task=deleteDMTask'.$layoutUrl).'">
