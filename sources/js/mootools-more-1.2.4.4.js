...
var special = ['Ă€','Ă ','Ă','Ăˇ','Ă‚','Ă˘','Ă','ĂŁ','Ă„','Ă¤','Ă…','ĂĄ','Ä‚','Ä','Ä„','Ä…','Ä†','Ä‡','ÄŚ','ÄŤ','Ă‡','Ă§', 'ÄŽ','ÄŹ','Ä','Ä‘', 'Ă','Ă¨','Ă‰','Ă©','ĂŠ','ĂŞ','Ă‹','Ă«','Äš','Ä›','Ä','Ä™', 'Äž','Äź','ĂŚ','Ă¬','ĂŤ','Ă­','ĂŽ','Ă®','ĂŹ','ĂŻ', 'Äą','Äş','Ä˝','Äľ','Ĺ','Ĺ‚', 'Ă‘','Ă±','Ĺ‡','Ĺ','Ĺ','Ĺ„','Ă’','Ă˛','Ă“','Ăł','Ă”','Ă´','Ă•','Ăµ','Ă–','Ă¶','Ă','Ă¸','Ĺ‘','Ĺ','Ĺ™','Ĺ”','Ĺ•','Ĺ ','Ĺˇ','Ĺž','Ĺź','Ĺš','Ĺ›', 'Ĺ¤','ĹĄ','Ĺ¤','ĹĄ','Ĺ˘','ĹŁ','Ă™','Ăą','Ăš','Ăş','Ă›','Ă»','Ăś','ĂĽ','Ĺ®','ĹŻ', 'Ĺ¸','Ăż','Ă˝','Ăť','Ĺ˝','Ĺľ','Ĺą','Ĺş','Ĺ»','ĹĽ', 'Ăž','Ăľ','Ă','Ă°','Ăź','Ĺ’','Ĺ“','Ă†','Ă¦','Âµ'];
...
authors:
- Sebastian MarkbĂĄge, Aaron Newton, Lennart Pilon, Valerio Proietti
