window.addEvent('domready', function(){
    ...
    asocRule = new AsociationRules("en","testGetInfo.php","testSetInfo.php","testHitsInfo.php?" + params); //third param is the page on server to be called at saving rules
