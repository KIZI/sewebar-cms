...
$json = "{\"rule0\":[{\"name\":\"status\",\"type\":\"attr\",\"category\":\"One Category\",\"fields\":[{\"name\":\"category\",\"value\":\"cat1\"}]},{\"name\":\"Support\",\"type\":\"oper\",\"fields\":[{\"name\":\"min value\",\"value\":\"\"}]},{\"name\":\"Confidence\",\"type\":\"oper\",\"fields\":[{\"name\":\"min value\",\"value\":\"\"}]},{\"name\":\"duration\",\"type\":\"attr\",\"category\":\"One Category\",\"fields\":[{\"name\":\"category\",\"value\":\"cat2\"}]}],\"rules\":1}";
...
$filePath = "resultAsociationRule.xml";
