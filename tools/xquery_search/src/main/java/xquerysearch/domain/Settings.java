...
public class Settings {
	...
	private String qbarTransformationPath;
	 ...
	 */
	public boolean getUseTransformationBool() {
	 ...
	 * @return <code>TRUE</code> if transformation should be used 
	 */
	public String getUseTransformation() {
		return String.valueOf(useTransformation);
	}
	 ...
	 * @param useTransformation
	 */
	public void setUseTransformation(String useTransformation) {
		setUseTransformation(Boolean.parseBoolean(useTransformation));
	}
	...
	/**
	 * @return the qbarTransformationPath
	 */
	public String getQbarTransformationPath() {
		return qbarTransformationPath;
	}

	/**
	 * @param qbarTransformationPath the qbarTransformationPath to set
	 */
	public void setQbarTransformationPath(String qbarTransformationPath) {
		this.qbarTransformationPath = qbarTransformationPath;
	}
	 ...
	 * @throws IOException 
	 */
	public Settings changeSettings(File settingsFile, HttpServletRequest request) {
		...
		this.setUseTransformation(request.getParameter("useTransformation"));
