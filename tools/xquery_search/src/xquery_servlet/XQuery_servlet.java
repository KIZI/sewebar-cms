...
public class XQuery_servlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		/*
		 * Nastaveni zpusobu a kodovani vystupu a vstupu, inicializace
		 * promennych pro vystup
		 */
...
//								+ "]]></error>";
	 ...
	 * @return zprava / chyba
	 */
	private String[] getSettingsFile() throws IOException{
	 ...
	 */
	private String processRequest(String action, String id, String docName,
			String creationTime, String reportUri, boolean restructure,
			String content, XmlManager mgr, QueryHandler qh, BDBXMLHandler bh,
			QueryMaker qm, Tester tester) throws IOException, ParserConfigurationException, SAXException, XmlException, XPathExpressionException, TransformerException {
		...
		if (except_bool == false && id.isEmpty()) {
			...
			case 4:
				...
				break;
			case 5:
				output += "<query><![CDATA[" + qh.getQuery(id)[1].toString() + "]]></query>";
				break;
			case 6:
				output += qh.deleteQuery(id);
				break;
			case 7:
