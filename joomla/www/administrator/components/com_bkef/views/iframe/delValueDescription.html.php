...
class BkefViewDelValueDescription extends JView
{
  ...
  {               
      ...
      echo '<h1>'.JText::_('DELETING_VALUE_DESCRIPTION').'</h1>';
      ...
      echo '<div>';
        ...
        echo JText::_('DELETING_VALUE_DESCRIPTION_QUESTION').' <strong>';
        echo $xml->MetaAttributes[0]->MetaAttribute[$maId]->Formats[0]->Format[$fId]->ValueDescriptions[0]->ValueDescription[$vdId]['type'];
        echo '</strong>?
      </div>    <br /><br />';
      ?>
      <form action="index.php?option=com_bkef&amp;task=delValueDescription" method="post" target="_parent" >
