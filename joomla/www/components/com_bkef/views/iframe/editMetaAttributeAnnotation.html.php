...
class BkefViewEditMetaAttributeAnnotation extends JView
{
  ...
  {               
      ...
      if ($anId!=-1){
        $annotation=$xml->MetaAttributes[0]->MetaAttribute[$maId]->Annotations[0]->Annotation[$anId];
      }
...
?>
      <form action="index.php?option=com_bkef&amp;task=<?php echo $this->akce;?>MetaAttributeAnnotation" method="post" target="_parent" >
        <table>
          <tr>
