...
{
	public class TaskPooler : API.HttpHandlerSession
	{
		...
		public override void ProcessRequest(HttpContext context)
		{
			...
			if (this.Miner != null && this.Request.Task != null)
			{
				...
				exporter.Output = String.Format("{0}/results_{1}_{2:yyyyMMdd-Hmmss}.xml", this.Request.DataFolder,
												this.Request.TaskFileName, DateTime.Now);
			...
			else
			{
				...
				this.Response.Message = "No LISpMiner instance or task defined";
			}
