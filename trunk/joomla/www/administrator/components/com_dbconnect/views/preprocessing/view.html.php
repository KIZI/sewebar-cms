 ...
 * @subpackage Config
 */
class dbconnectViewPreprocessing extends JView
{
	/**
	 * Display the view
	 */
    ...
    $this->assignRef('fmlModel',$fmlModel);
    
    $this->assignRef('fieldMappingsArr',$fmlModel->getFieldMappingsArr());
    $this->assignRef('pmmlFieldNamesArr',$fmlModel->getPmmlFieldNamesArr());
    $this->assignRef('bkefFieldArr',$fmlModel->getBkefFieldsArr());
