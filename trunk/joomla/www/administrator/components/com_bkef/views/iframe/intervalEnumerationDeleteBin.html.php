...
class BkefViewIntervalEnumerationDeleteBin extends JView
{
  ...
  {               
      ...
      echo '</div>';
      echo '<strong>'.((string)@$this->xml->MetaAttributes[0]->MetaAttribute[$this->maId]->Formats[0]->Format[$this->fId]->PreprocessingHints[0]->DiscretizationHint[$this->phId]->IntervalEnumeration[0]->IntervalBin[$this->binId]->Name[0]).'</strong>';
      echo '<br /><br />';
      ?>
