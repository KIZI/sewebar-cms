...
class BkefViewEditFormatAnnotation extends JView
{
...
?>
      <form action="index.php?option=com_bkef&amp;task=<?php echo $this->akce;?>FormatAnnotation" method="post" target="_parent" >
        <table>
          <tr>
