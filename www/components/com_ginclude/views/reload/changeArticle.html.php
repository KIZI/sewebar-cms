...
class GincludeViewChangeArticle extends JView
{
  /**
  ...
  function articlesHtml(){
    ...
    $result.= '<form action="index.php?option=com_ginclude&amp;task=reloadChangeArticle&amp;tmpl=component&amp;oldId='.$oldId.'" name="adminForm" id="adminForm" method="post">';
