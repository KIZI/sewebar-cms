...
class GetDataARBuilderQuery extends AncestorGetData {
    ...
    private function solveExistingRules() {
        // Dostanu soubor ve form�tu ARBuilder.
        // Tento form�t se n�sledn� d�l� do t�� form�tu: ARQuery, TaskSetting a AssociationRules
        // Z toho ARQuery a TaskSetting se zpracov�vaj� stejn�. Li�� se pouze spodek.
        // Ka�dop�dn� to p�ev�d�me do Element�. ze kter�ch se vyr�b� JSON
